...
class TestSendAlert:
    ...
    def test_send_alert_success(self, mocker):
        ...
        mock_post = mocker.patch('sue_books_org.dags.utils.requests.post')
...
class TestCheckAndCreateDb:
    ...
    def test_check_and_create_db_creates_new_db(self, mocker):
        ...
        mock_connect = mocker.patch('sue_books_org.dags.utils.psycopg2.connect')
...
class TestUpsertFromDf:
    ...
    def test_upsert_from_df_duplicates(self, mocker):
        ...
        mocker.patch('sue_books_org.dags.utils.execute_values')
    ...
    def test_upsert_from_df_chunking(self, mocker):
        ...
        mock_execute_values = mocker.patch('sue_books_org.dags.utils.execute_values')
        mock_conn = mocker.MagicMock()
        mock_cur = mocker.MagicMock()
        mock_conn.cursor.return_value.__enter__.return_value = mock_cur
...
class TestCreateTables:
    ...
    def test_create_tables_success(self, mocker):
        ...
        mock_check_db = mocker.patch('sue_books_org.dags.utils.check_and_create_db')
        mock_get_db = mocker.patch('sue_books_org.dags.utils.get_db')
    ...
    def test_create_tables_error_handling(self, mocker):
        ...
        mocker.patch('sue_books_org.dags.utils.check_and_create_db')
        mock_get_db = mocker.patch('sue_books_org.dags.utils.get_db')
